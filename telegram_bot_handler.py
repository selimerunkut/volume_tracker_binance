...
from src.services.llm_strategy import analyze_and_suggest as llm_analyze_and_suggest
...
async def analyze_symbol(update: Update, context: ContextTypes.DEFAULT_TYPE, symbol: str | None = None, exchange_scope=None, preserve_source_message: bool = False) -> None:
    """Analyze a symbol with the deterministic signal and one OpenRouter comparison."""
